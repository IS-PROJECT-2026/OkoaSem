...
function SectionHeader({ label, title, subtitle }) {
  return (
    <motion.div
      ...
      className="mb-14"
    >
      <span className="text-xs font-semibold tracking-[0.25em] uppercase text-[#d4af6a] mb-3 block">{label}</span>
...
const JaedonPortfolio = () => {
  ...
  return (
    <div className="relative min-h-screen text-zinc-300 selection:bg-[#d4af6a]/30">
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <a href="#home" className="font-display text-xl font-bold text-white flex items-center gap-2 group">
            <motion.span whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
              <Terminal className="text-[#d4af6a]" size={22} />
            </motion.span>
            {PROFILE.firstName}<span className="text-[#d4af6a]">.</span>
          </a>
            ...
            {NAV_ITEMS.map((item) => (
              <a
                ...
                className={`relative px-4 py-2 text-sm font-medium rounded-full transition-all duration-300 ${
                  activeSection === item.id ? 'text-[#d4af6a]' : 'text-zinc-500 hover:text-zinc-200'
                }`}
              >
                {activeSection === item.id && (
                  <motion.span
                    layoutId="nav-pill"
                    className="absolute inset-0 bg-[#d4af6a]/10 border border-[#d4af6a]/20 rounded-full"
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden md:flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium bg-[#d4af6a]/10 text-[#d4af6a] border border-[#d4af6a]/25 hover:bg-[#d4af6a]/20 transition-all"
            >
              <Mail size={16} />
              Contact
            </a>
              ...
              <div className="px-6 py-4 flex flex-wrap gap-2">
                {NAV_ITEMS.map((item) => (
                  <a
                    ...
                    className="px-4 py-2 text-sm rounded-full bg-white/5 text-zinc-300 hover:text-[#d4af6a]"
                  >
                    {item.label}
                  </a>
                ))}
        ...
        <section id="home" ref={heroRef} className="min-h-screen flex items-center pt-24 pb-16">
          <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
            <motion.div style={{ y: heroY, opacity: heroOpacity }}>
              ...
              >
                ...
                <span className="text-[#d4af6a]">· Nairobi</span>
              </motion.div>
              ...
              >
                <a
                  href="#projects"
                  className="group flex items-center gap-2 px-7 py-3.5 rounded-xl font-medium text-[#06060b] bg-[#d4af6a] hover:bg-[#e8c87a] transition-all shadow-lg shadow-[#d4af6a]/20"
                >
                  View Projects
            ...
            >
              <div
                ...
                style={{ background: 'radial-gradient(circle, #d4af6a 0%, #8b5cf6 50%, transparent 70%)', animation: 'pulse-glow 4s ease-in-out infinite' }}
              />
              <Cube3D />
              <motion.div
                animate={{ y: [0, -12, 0] }}
          ...
          >
            {stats.map((stat, i) => (
              ...
              >
                <div className="p-2 rounded-lg bg-[#d4af6a]/10">
                  <stat.icon size={18} className="text-[#d4af6a]" />
                </div>
                <div>
              ...
              {TECH_STACK.map((group, i) => (
                <button
                  ...
                  className={`w-full text-left px-5 py-4 rounded-xl transition-all duration-300 flex items-center gap-3 ${
                    activeStack === i
                      ? 'glass-card border-[#d4af6a]/30 text-white'
                ...
                >
                  ...
                  {activeStack === i && (
                    <motion.div layoutId="stack-indicator" className="ml-auto w-1.5 h-1.5 rounded-full bg-[#d4af6a]" />
                  )}
                </button>
              ))}
            </motion.div>
              ...
              <motion.div key={project.id} variants={fadeUp} custom={i} className={i === 0 ? 'md:col-span-2 lg:col-span-1' : ''}>
                <TiltCard className="glass-card rounded-3xl p-8 h-full group relative overflow-hidden">
                  ...
                  <div className="tilt-card-inner relative z-10 flex flex-col h-full">
                    ...
                    <h3 className="font-display text-xl font-bold text-white mb-3 group-hover:text-[#d4af6a] transition-colors">
                      {project.title}
                    </h3>
        ...
        <section id="systems" className="py-28">
          ...
          >
            <h3 className="font-display text-xl font-bold text-white mb-6 flex items-center gap-2">
              <Cpu size={20} className="text-[#d4af6a]" />
              Hardware & Gear
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {HARDWARE.map((item, i) => (
                ...
                >
                  <item.icon size={24} className="mx-auto mb-3 text-zinc-500 group-hover:text-[#d4af6a] transition-colors" />
              ...
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                  activeLifeTab === tab.id
                    ? 'bg-[#d4af6a]/15 text-[#d4af6a] border border-[#d4af6a]/30'
                ...
                <TiltCard className="glass-card rounded-3xl p-8 md:p-10">
                  <div className="tilt-card-inner">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="p-3 rounded-xl bg-[#d4af6a]/10">
                        <tab.icon size={24} className="text-[#d4af6a]" />
                      </div>
      ...
      <footer id="contact" className="relative z-10 mt-8">
        ...
        <div className="max-w-7xl mx-auto px-6 pb-16">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-[#d4af6a]/5 via-transparent to-[#8b5cf6]/5 pointer-events-none" />
            <div className="relative z-10">
              ...
              >
                <Sparkles size={32} className="text-[#d4af6a]" />
              </motion.div>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a
                  href={`mailto:${PROFILE.email}`}
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-medium text-[#06060b] bg-[#d4af6a] hover:bg-[#e8c87a] transition-all shadow-lg shadow-[#d4af6a]/20"
                >
                  <Mail size={18} />
                  {PROFILE.email}
                </a>
